class ProductPage {
    constructor(page) {
        ...
        this.modalViewCartBtn = page.locator('#cartModal a[href="/view_cart"]');
        this.modalContinueBtn = page.locator('#cartModal button:has-text("Continue Shopping")');
    ...
    // Modal Actions — wait for Bootstrap .show class before interacting
    async continueShopping() {
        await this.page.locator('#cartModal.show').waitFor({ state: 'visible' });
    ...
    // Category Actions
    async clickWomenCategory() { await this.womenCategory.click(); }
    async clickMenCategory()   { await this.menCategory.click(); }
    async clickKidsCategory()  { await this.kidsCategory.click(); }
